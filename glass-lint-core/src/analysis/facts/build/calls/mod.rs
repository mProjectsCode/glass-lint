...
impl FactBuilder<'_, '_> {
    pub(in crate::analysis::facts::build) fn record_call_expr(&mut self, call: &CallExpr) {
    ...
    pub(in crate::analysis::facts::build) fn emit_call(
        &mut self,
        span: Span,
    ...
    pub(in crate::analysis::facts::build) fn call_result(&mut self, span: Span) -> ValueId {
    ...
    pub(in crate::analysis::facts::build) fn value_for_expr(&mut self, expr: &Expr) -> ValueId {
