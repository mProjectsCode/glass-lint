// @case description Ported old classifier case: string literal markers in literals and templates
...
const endpoint = "https://api.openai.com/v1/chat/completions"; // @expect-error glass-lint rule=obsidian:vault.uri message_id=detected line=8
// @expect-error-after glass-lint rule=obsidian:network.ai_provider message_id=detected
const templatedCallback = `obsidian://open?vault=${vault}`;
