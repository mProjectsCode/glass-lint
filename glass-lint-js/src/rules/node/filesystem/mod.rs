...
pub fn rule() -> Rule {
    let mut builder = Rule::builder("node.filesystem")
        ...
        .matcher(Matcher::package_import("fs-extra").unwrap())
        .matcher(Matcher::package_import("graceful-fs").unwrap())
        .matcher(Matcher::package_import("memfs").unwrap())
        .matcher(Matcher::package_import("unionfs").unwrap())
        .matcher(Matcher::package_import("chokidar").unwrap())
        .matcher(Matcher::package_import("proper-lockfile").unwrap())
        .matcher(Matcher::package_import("tmp").unwrap())
        .matcher(Matcher::package_import("tmp-promise").unwrap())
        .matcher(Matcher::package_import("rimraf").unwrap())
        .matcher(Matcher::package_import("mkdirp").unwrap())
        .matcher(Matcher::package_import("make-dir").unwrap())
        .matcher(Matcher::package_import("write-file-atomic").unwrap())
        .matcher(Matcher::package_import("fs-monkey").unwrap())
        .matcher(Matcher::package_import("mock-fs").unwrap())
        .matcher(Matcher::package_import("watchpack").unwrap())
        .matcher(Matcher::package_import("fsevents").unwrap());
