...
/// from them: `getItem`/`setItem` on local and session storage, `indexedDB.open`,
/// and `caches.open`. Other storage methods, shadowed globals, and reassigned
/// aliases are outside this rule's scope.
