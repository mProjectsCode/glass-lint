...
this.app.fileManager.processFrontMatter(file, data => { data.legacy = true; }); // @expect-error glass-lint rule=obsidian:file-manager.frontmatter-write message_id=detected
