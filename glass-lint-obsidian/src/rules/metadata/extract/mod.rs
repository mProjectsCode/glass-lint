...
/// reassigned aliases, dynamic properties, and unlisted collections are excluded.
/// The rule reads member chains; it does not infer collections from arbitrary
/// `getFileCache(...)` return values.
